...
namespace Coffee.NanoMonitor
{
    public class FixedFont
    {
        ...
        public static FixedFont GetOrCreate(Font font)
        {
            ...
            Profiler.BeginSample("(NM)[FixedFont] GetOrCreate");
        ...
        public void UpdateFont()
        {
            ...
            Profiler.BeginSample("(NM)[FixedFont] UpdateFont");
        ...
        public float Append(VertexHelper vh, char c, float offset, float scale, Color color)
        {
            if (_verts == null || _charInfos == null) return offset;
            if (c < 0x20 || 0x7e < c) return offset;
            var ci = c - 0x20;
            Profiler.BeginSample("(NM)[FixedFont] Append");
            ...
            vh.AddUIVertexQuad(_tmpVerts);
            Profiler.EndSample();

            return offset + _charInfos[ci].charWidth * scale;
        }

        public void Fill(VertexHelper vh, Color color, RectTransform tr)
        {
            if (_verts == null || _charInfos == null) return;
            Profiler.BeginSample("(NM)[FixedFont] Fill");
